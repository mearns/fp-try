    ...
    (function() {
        ...
        (h.reduce = h.foldl = h.inject = O(1)),
            ...
            (h.max = function(n, e, r) {
                ...
                if (
                    ...
                    for (
                        var a = 0, c = (n = w(n) ? n : h.values(n)).length;
                        a < c;
                        a++
                    )
                        null != (t = n[a]) && i < t && (i = t);
        ...
        (h.toArray = function(n) {
            ...
            (h.initial = function(n, r, t) {
                return c.call(
                    n,
                    0,
                    Math.max(0, n.length - (null == r || t ? 1 : r))
                );
            }),
        ...
        (h.flatten = function(n, r) {
            ...
            (h.intersection = function(n) {
                for (
                    var r = [], t = arguments.length, e = 0, u = A(n);
                    e < u;
                    e++
                ) {
                    var i = n[e];
        ...
        (h.bind = g(function(r, t, e) {
            ...
            (h.partial = g(function(u, i) {
                var o = h.partial.placeholder,
                    a = function() {
                        for (
                            var n = 0, r = i.length, t = Array(r), e = 0;
                            e < r;
                            e++
                        )
        ...
        (h.keys = function(n) {
            ...
            (h.values = function(n) {
                for (
                    var r = h.keys(n), t = r.length, e = Array(t), u = 0;
                    u < t;
                    u++
                )
                    e[u] = n[r[u]];
            ...
            (h.mapObject = function(n, r, t) {
                r = d(r, t);
                for (
                    var e = h.keys(n), u = e.length, i = {}, o = 0;
                    o < u;
                    o++
                ) {
                    var a = e[o];
    ...
    (function(t) {
        ...
        (a.off = function(t, e, i) {
            ...
            (a.stopListening = function(t, e, n) {
                ...
                if (!r) return this;
                for (
                    var s = t ? [t._listenId] : i.keys(r), a = 0;
                    a < s.length;
                    a++
                ) {
                    var o = r[s[a]];
        ...
        (a.once = function(t, e, i) {
            ...
            return (
                "string" == typeof t && null == i && (e = void 0),
                this.on(n, e, i)
            );
        }),
        ...
        i.extend(m.prototype, a, {
            ...
            save: function(t, e, n) {
                ...
                (n.success = function(t) {
                    ...
                    if ((s && (e = i.extend({}, r, e)), e && !a.set(e, n)))
                        return !1;
        ...
        i.extend(_.prototype, a, {
            ...
            get: function(t) {
                if (null != t)
                    return (
                        this._byId[t] ||
                        this._byId[
                            this.modelId(this._isModel(t) ? t.attributes : t)
                        ] ||
            ...
            _prepareModel: function(t, e) {
                ...
                var n = new ((e = e ? i.clone(e) : {}).collection = this).model(
                    t,
                    e
                );
            ...
            _onModelEvent: function(t, e, i, n) {
                if (e) {
                    ...
                    if (
                        ("destroy" === t && this.remove(e, n), "change" === t)
                    ) {
        ...
        i.extend(T.prototype, a, {
            ...
            delegate: function(t, e, i) {
                return (
                    this.$el.on(t + ".delegateEvents" + this.cid, e, i), this
                );
            },
            ...
            undelegate: function(t, e, i) {
                return (
                    this.$el.off(t + ".delegateEvents" + this.cid, e, i), this
                );
            },
            ...
            (e.sync = function(t, n, r) {
                ...
                if (
                    ...
                    r.beforeSend = function(t) {
                        if (
                            (t.setRequestHeader("X-HTTP-Method-Override", s), o)
                        )
            ...
            i.extend(B.prototype, a, {
                ...
                start: function(t) {
                    ...
                    if (
                        ...
                        var n = document.body,
                            r = n.insertBefore(this.iframe, n.firstChild)
                                .contentWindow;
                        r.document.open(),
                            r.document.close(),
                ...
                navigate: function(t, e) {
                    ...
                    if (this.fragment !== r) {
                        if (((this.fragment = r), this._usePushState))
                            this.history[
                                e.replace ? "replaceState" : "pushState"
                            ]({}, document.title, n);
                        else {
                            ...
                            if (
                                ...
                                e.replace ||
                                    (s.document.open(), s.document.close()),
    ...
    (function() {
        ...
        (e.version = "2.3.7"),
            ...
            (e.Set.prototype.intersect = function(t) {
                ...
                (i =
                    this.length < t.length ? ((r = this), t) : ((r = t), this)),
            ...
            (e.Vector.prototype.magnitude = function() {
                ...
                for (
                    var e = 0, t = this.elements.length, r = 1;
                    r < t;
                    r += 2
                ) {
            ...
            (e.Builder.prototype.add = function(t, r) {
                ...
                for (var s = 0; s < n.length; s++) {
                    ...
                    for (var f = 0; f < c.length; f++) {
                        ...
                        for (
                            var v = 0;
                            v < this.metadataWhitelist.length;
                            v++
                        ) {
            ...
            (e.MatchData.prototype.combine = function(e) {
                for (
                    var t = Object.keys(e.metadata), r = 0;
                    r < t.length;
                    r++
                ) {
                    var i = t[r],
                ...
                if (t in this.metadata[e])
                    for (var i = Object.keys(r), n = 0; n < i.length; n++) {
                        ...
                        s in this.metadata[e][t]
                            ? (this.metadata[e][t][s] = this.metadata[e][t][
                                  s
                              ].concat(r[s]))
            ...
            (e.QueryParser.parsePresence = function(t) {
                ...
                if (null != r) {
                    switch (r.str) {
                        case "-":
                            t.currentClause.presence =
                                e.Query.presence.PROHIBITED;
                            break;
                        case "+":
                            t.currentClause.presence =
                        ...
                        default:
                            var i =
                                "unrecognised presence operator'" + r.str + "'";
                        ...
                        (c.namespace != namespace && "*" != c.namespace) ||
                            $context.find(c.selector).each(function(m, el) {
                                ...
                                (instance = $el.data("component"))
                                    ? -1 == _(result).indexOf(instance) &&
                                      result.push(instance)
                                    : ((instance = new c.constructor({
                                          el: el
                                      })),
        ...
        var Viewport = (function(_super) {
            function Viewport() {
                ...
                return (
                    ...
                    (_this.height = 0),
                    (_this.showToolbar = !0),
                    (_this.toolbar = document.querySelector(
                        ".tsd-page-toolbar"
                    )),
        ...
        var FilterItem = (function() {
            ...
            FilterItemCheckbox = (function(_super) {
                function FilterItemCheckbox() {
                    return (
                        (null !== _super && _super.apply(this, arguments)) ||
                        this
                    );
                }
                return (
                ...
                return (
                    ...
                    (FilterItemSelect.prototype.initialize = function() {
                        ...
                        typedoc.$html.addClass(
                            ...
                            typedoc.$document.on(typedoc.pointerDown, function(
                                e
                            ) {
                                $(e.target)
                                    .parents()
            ...
            Filter = (function(_super) {
                function Filter(options) {
                    ...
                    return (
                        ...
                        (_this.optionInherited = new FilterItemCheckbox(
                            "inherited",
                            !0
                        )),
                        (_this.optionExternals = new FilterItemCheckbox(
                            "externals",
                            !0
                        )),
            ...
            return (
                ...
                (MenuHighlight.prototype.onScroll = function(scrollTop) {
                    ...
                    for (
                        ;
                        index < count &&
                        anchors[index + 1].position < scrollTop;
    ...
    (function(typedoc) {
        ...
        !(function(search) {
            ...
            !(function(SearchLoadingState) {
                (SearchLoadingState[(SearchLoadingState.Idle = 0)] = "Idle"),
                    (SearchLoadingState[(SearchLoadingState.Loading = 1)] =
                        "Loading"),
                    (SearchLoadingState[(SearchLoadingState.Ready = 2)] =
                        "Ready"),
            ...
            function updateResults() {
                if (
                    ($results.empty(),
                    loadingState == SearchLoadingState.Ready && query)
                ) {
            ...
            function setLoadingState(value) {
                loadingState != value &&
                    ($el.removeClass(
                        SearchLoadingState[loadingState].toLowerCase()
                    ),
                    (loadingState = value),
                    $el.addClass(
                        SearchLoadingState[loadingState].toLowerCase()
            ...
            function setCurrentResult(dir) {
                ...
                if (0 == $current.length)
                    ...
                    var $rel =
                        1 == dir ? $current.next("li") : $current.prev("li");
                    0 < $rel.length &&
    ...
    (function(typedoc) {
        ...
        (typedoc.transition = (function(tuples) {
            for (var name in tuples)
                if (
                    tuples.hasOwnProperty(name) &&
                    void 0 !== document.body.style[name]
                )
                    ...
                    from != to && typedoc.transition
                        ? ($el.css("height", to),
                          $el.on(typedoc.transition.endEvent, function() {
                              noTransition($el, function() {
                                  $el
                                      .off(typedoc.transition.endEvent)
                                      .css("height", ""),
                                      success && success();
                              });
                          }))
    ...
    (function(typedoc) {
        var SignatureGroup = (function() {
                ...
                return (
                    ...
                    (SignatureGroup.prototype.removeClass = function(
                        className
                    ) {
                        return (
                ...
                function Signature(options) {
                    ...
                    return (
                        ...
                        _this.$container &&
                            (_this.$el
                                .addClass("active")
                                .on("touchstart", ".tsd-signature", function(
                                    event
                                ) {
                ...
                return (
                    ...
                    (Signature.prototype.createGroups = function() {
                        ...
                        if (!($signatures.length < 2)) {
                            this.$container = this.$el.siblings(
                                ".tsd-descriptions"
                            );
                            var $descriptions = this.$container.find(
                                "> .tsd-description"
                            );
                            (this.groups = []),
                    ...
                    (Signature.prototype.onClick = function(e) {
                        ...
                        _(this.groups).forEach(function(group, index) {
                            group.$signature.is(e.currentTarget) &&
                        ...
                        if ($path.hasClass("col-menu")) {
                            ...
                            if ($link.length) {
                                ...
                                -1 != href.indexOf("#") &&
                                    ...
                                    $link.prop("href").substr(0, href.length) ==
                                        href &&
                                        setTimeout(function() {
