...
| `Try.fromPromise(p)`                         | `Promise.<Try.<T>>` | Given a Promise for a value, returns a Promise for a Try of that value.                                                                                                                                           |
...
| `Try.createUnTryOperator(Observable)`        | `function`          | Similar to `createTryOperator`, this returns an Observable operator that unpacks Try values emitted by an observable.                                                                                             |
| `Try.Success(value)`                         | `Try.<T>`           | Creates a successful Try encapsulating the given value.                                                                                                                                                           |
| `Try.Failure(error)`                         | `Try.<T>`           | Creates a failure Try encapsulating the given error.                                                                                                                                                              |
| `Try::isSuccess()`                           |                     |                                                                                                                                                                                                                   |
| `Try::isFailure()`                           |                     |                                                                                                                                                                                                                   |
